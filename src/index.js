...
const {
  lenversProductLinksScraper,
  lenversProductInfoesScraper,
} = require("./lenvers/scrapers");
const {
  blueVerdProductLinksScraper,
  blueVerdProductInfoesScraper,
} = require("./blu_verd/scrapers");
...
const main = async () => {
  try {
    ...
    */
    ...
    const lenversProductsInfo = await lenversProductInfoesScraper(
      lenversProductsLinks,
      page
    );
    /* 
      Blue Verd
    */
    ...
    const bluVerdProductsInfo = await blueVerdProductInfoesScraper(
      blueVerdProductsLink,
      page
    );
